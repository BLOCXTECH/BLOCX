...
This mechanism has been integrated into Bitcore-Node-BLOCX which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/blocxpay/insight-api-blocx#web-socket-api](https://github.com/blocxpay/insight-api-blocx#web-socket-api)
* API: [https://github.com/blocxpay/insight-api-blocx#instantsend-transactions](https://github.com/blocxpay/insight-api-blocx#instantsend-transactions)
