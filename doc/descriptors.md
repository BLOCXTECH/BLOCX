# Support for Output Descriptors in BLOCX Core

Since BLOCX Core v0.17, there is support for Output Descriptors. This is a
...
existing BLOCX Core wallets, a convenience function `combo` is
...
All RPCs in BLOCX Core will include the checksum in their output. Only
