...
* blocx.conf: contains configuration settings for blocxd or blocx-qt
* blocxd.pid: stores the process id of blocxd while running
...
* debug.log: contains debug information and general logging generated by blocxd or blocx-qt
