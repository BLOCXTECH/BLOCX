...
-----------------------
Building the dependencies and BLOCX Core requires some essential build tools and libraries to be installed before.
...
Disable-wallet mode
--------------------
When the intention is to run only a P2P node without a wallet, BLOCX Core may be compiled in
