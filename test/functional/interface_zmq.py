...
from test_framework.messages import blocxhash
...
def blocxhash_helper(b):
    return encode(blocxhash(b)[::-1], 'hex_codec').decode('ascii')
...
class ZMQTest (BitcoinTestFramework):
    ...
    def _zmq_test(self):
        ...
        for x in range(num_blocks):
            ...
            assert_equal(genhashes[x], blocxhash_helper(block[:80]))
