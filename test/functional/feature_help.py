...
"""Verify that starting blocxd with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blocxd with -h for help text")
        ...
        self.log.info("Start blocxd with -version for version information")
        ...
        self.log.info("Start blocxdd with -fakearg to make sure it does not start")
