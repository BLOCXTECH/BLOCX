...
#ifndef BLOCX_CRYPTO_BLS_H
#define BLOCX_CRYPTO_BLS_H
...
// bls-blocx uses relic, which may define DEBUG and ERROR, which leads to many warnings in some build setups
#undef ERROR
#undef DEBUG
