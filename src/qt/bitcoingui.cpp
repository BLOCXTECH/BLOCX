...
void BitcoinGUI::createActions()
{
    ...
    coinJoinCoinsMenuAction->setStatusTip(tr("Send %1 funds to a BLOCX address").arg(strCoinJoinName));
    ...
    openAction->setStatusTip(tr("Open a blocx: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible BLOCX command-line options").arg(PACKAGE_NAME));
