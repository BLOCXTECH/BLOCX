...
/** Utility functions used by the BLOCX Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "blocx:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load blocx specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a blocx specific theme is activated (light/dark).*/
