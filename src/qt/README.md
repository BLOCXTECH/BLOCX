This directory contains the BLOCXQT graphical user interface (GUI). It uses the cross-platform framework [Qt](https://www1.qt.io/developers/).
...
Represents the main window of the BLOCX UI.
...
* don't change `local/blocx_en.ts`; this happens [automatically](/doc/translation_process.md#writing-code-with-translations)
...
10. Start debugging with Qt Creator (you might need to the executable to "blocx-qt" under "Run", which is where you can also add command line arguments)
