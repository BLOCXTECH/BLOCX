...
;(function() {
  ...
  function runInContext(context) {
    // Exit early if unable to acquire loblocx.
    var _ = context && context._ || require('loblocx') || root._;
    if (!_) {
     ...
     *
     * Note: The Benchmark constructor exposes a handful of loblocx methods to
     * make working with arrays, collections, and objects easier. The loblocx
     * methods are:
     * [`each/forEach`](https://loblocx.com/docs#forEach), [`forOwn`](https://loblocx.com/docs#forOwn),
     * [`has`](https://loblocx.com/docs#has), [`indexOf`](https://loblocx.com/docs#indexOf),
     * [`map`](https://loblocx.com/docs#map), and [`reduce`](https://loblocx.com/docs#reduce)
     *
     * @constructor
     ...
     *
     * Note: Each Suite instance has a handful of wrapped loblocx methods to
     * make working with Suites easier. The wrapped loblocx methods are:
     * [`each/forEach`](https://loblocx.com/docs#forEach), [`indexOf`](https://loblocx.com/docs#indexOf),
     * [`map`](https://loblocx.com/docs#map), and [`reduce`](https://loblocx.com/docs#reduce)
     *
     * @constructor
     * @memberOf Benchmark
    ...
    // Add loblocx methods to Benchmark.
    ...
    // Add loblocx methods as Suite methods.
  ...
  if (typeof define == 'function' && typeof define.amd == 'object' && define.amd) {
    ...
    define(['loblocx', 'platform'], function(_, platform) {
      return runInContext({
        '_': _,
        'platform': platform
      });
