...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " blocx-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  blocx-tx [options] <hex-tx> [commands]  Update hex-encoded blocx transaction\n" +
            "or:     blocx-tx [options] -create [commands]   Create hex-encoded blocx transaction\n" +
            "\n";
