 ...
 * between blocxd, and blocx-qt and non-server tools.
*/
...
void SetupServerArgs()
{
    ...
    gArgs.AddArg("-sporkaddr=<blocxaddress>", "Override spork address. Only useful for regtest and devnet. Using this on mainnet or testnet will ban you.", false, OptionsCategory::DEBUG_TEST);
    ...
    gArgs.AddArg("-platform-user=<user>", "Set the username for the \"platform user\", a restricted user intended to be used by BLOCX Platform, to the specified username.", false, OptionsCategory::MASTERNODE);
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BLOCXTECH/BLOCX..git>";
...
bool AppInitMain()
{
        ...
        do {
            ...
            try {
                ...
                if (!fDisableGovernance && !fTxIndex
                   && chainparams.NetworkIDString() != CBaseChainParams::REGTEST) { // TODO remove this when pruning is fixed. See https://github.com/BLOCXTECH/BLOCX..git/pull/1817 and https://github.com/BLOCXTECH/BLOCX..git/pull/1743
    ...
    // ********************************************************* Step 10c: schedule BLOCX-specific tasks
