...
RCSUBDIR="test"
HOST1="https://github.com/BLOCXTECH/BLOCX/releases/"
HOST2="https://pasta.keybase.pub/BLOCX-Core-Releases/"
BASEDIR=""
VERSIONPREFIX=""
RCVERSIONSTRING="rc"
...
if [ $RET -ne 0 ]; then
   if [ $RET -eq 1 ]; then
      ...
      echo "gpg error. Do you have the BLOCX Core binary release signing key installed?"
   fi
