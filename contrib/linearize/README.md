...
https://github.com/blocxpay/blocx_hash
...
JSON-RPC server. Running `blocxd` or `blocx-qt -server` will be sufficient.
...
* `input`: blocxd blocks/ directory containing blkNNNNN.dat
