...
Arguments:
    <base_directory> - The base directory of a BLOCX Core source code repository.
...
Arguments:
    <base_directory> - The base directory of BLOCX Core source code repository.
"""
...
Arguments:
    <file> - A source file in the BLOCX Core repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The BLOCX
