...
([`valgrind.supp`](https://github.com/blocxpay/blocx/blob/master/contrib/valgrind.supp))
...
- ThreadSocketHandler : Sends/Receives data from peers on port 12972.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 12971 for connections and services them.
