...
This document provides guidelines for internationalization of the BLOCX Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `blocx_en.ts` remains unchanged.
