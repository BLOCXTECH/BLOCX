...
class BitcoinTestFramework():
    ...
    def main(self):
        ...
        parser.add_option("--srcdir", dest="srcdir", default=os.path.abspath(os.path.dirname(os.path.realpath(__file__)) + "/../../../src"),
                          help="Source directory containing blocxd/blocx-cli (default: %default)")
        ...
        parser.add_option("--blocxd-arg", dest="blocxd_extra_args", default=[], type='string', action='append',
    ...
    def _initialize_chain(self, extra_args=None, stderr=None):
        ...
        if create_cache:
            ...
            # Create cache directories, run blocxds:
            self.set_genesis_mocktime()
            for i in range(MAX_NODES):
...
class BLOCXTestFramework(BitcoinTestFramework):
    def set_blocx_test_params(self, num_nodes, masterodes_count, extra_args=None, fast_dip3_enforcement=False):
